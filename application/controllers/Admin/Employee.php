...
class Employee extends CI_Controller {
  ...
  if (!$this->upload->do_upload('file')) 
   ...
   try {
    ...
    'duedate'=>$this->convertdate($rowData[0][4]),
    'permdate' =>$this->convertdate($rowData[0][5]),
    ...
    'birthdate'=>$this->convertdate($rowData[0][21]),
    'age' =>$rowData[0][22],
    ...
    'spouse'=>$rowData[0][47],
    'birth_date_spouse'=>$this->convertdate($rowData[0][48]),
    'child1'=>$rowData[0][49],
    'birth_date_child_1'=>$this->convertdate($rowData[0][49]),
    'education_child'=>$rowData[0][51],
    'child2'=>$rowData[0][52],
    'birth_date_child2'=>$this->convertdate($rowData[0][53]),
    'educationchild2' =>$rowData[0][54],
    'child3'=>$rowData[0][55],
    'birth_date_child3'=>$this->convertdate($rowData[0][55]),
