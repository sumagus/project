    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li class=""><a href="<?php echo site_url('Admin/Bpjs/index')?>"><i class="fa fa-circle-o text-aqua"></i> Detail BPJS</a></li>
            <li><a href="<?php echo site_url('Admin/Bpjs/generate')?>"><i class="fa fa-circle-o text-aqua"></i> Generate BPJS </a></li>
          </ul>
        </li>
          <li class="treeview">
          <a href="#">
