              ...
              <div class="login-box">
                ...
                <?php echo form_open($form_action)?>
                    <div class="form-group has-feedback"> 
                      <input type="type" class="form-control" placeholder="ID" name="id_jabatan" value="<?=$id?>">
                      <?=form_error('id_jabatan')?>
                    </div>
                    <div class="form-group has-feedback">
                      <input type="type" class="form-control" placeholder="Jabatan" name="jabatan" value="<?=$jabatan?>">
                      <?=form_error('jabatan')?>
                      <br>
                    <div class="row">
                      <div class="col-xs-4">
