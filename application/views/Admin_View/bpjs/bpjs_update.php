...
$jenis = $dataId->jenis;
$nama = $dataId->nama;
$persentase = $dataId->persentase;
$perusahaan = $dataId->perusahaan;
$pegawai = $dataId->pegawai;
      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            ...
            <!-- /.box-header -->
            <?php echo form_open("admin/bpjs/update/$dataId->id_bpjs",['method'=>'POSt'])?>
            <div class="box-body">
                   <div class="row">
            <div class="col-md-12">
              ...
              <!-- /.form-group -->
               <div class="form-group">
                ...
                <input type="text" class="form-control" name="persentase" id="persentase" value="<?=$persentase?> ">
                <?php echo form_error('persentase')?>
              </div>
              <!-- /.form-group -->
               <div class="form-group">
                <label for="perusahaan">Perusahaan</label>
                <input type="text" class="form-control" name="perusahaan" id="perusahaan" value="<?=$perusahaan?>">
                <?php echo form_error('perusahaan')?>
              </div>
              <!-- /.form-group -->
              <div class="form-group">
                <label for="pegawai">Pegawai</label>
                <input type="text" class="form-control" name="pegawai" id="perusahaan" value="<?=$pegawai?>">
