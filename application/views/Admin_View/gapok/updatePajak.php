        ...
        <!-- TABS --> 
          ...
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              <li class="active"><a href="#personal" data-toggle="tab">Pajak</a></li>
            </ul>
            <div class="tab-content">
              ...
              <!-------------------------------------------------------------- Personal --------------------------------------------------> 
                ...
                <?php echo form_open("admin/karyawan/updatePajak/$dataId->emp_no",['class'=>'form-horizontal'])?>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                         <input type="text"  name="npwp" class="form-control" id="npwp" value ="<?php echo $npwp?>">
                    </div>
                  </div>
                   <div class="form-group">
                    <label for="ptkp" class="col-sm-2 control-label">Status PTKP</label>
                    <div class="col-sm-10">
                         <select name ="ptkp" class="form-control" value =<?=set_value('ptkp')?>>
