        ...
        <div class="col-xs-12">
          <div class="box">
            ...
            <div class="box-body table-responsive no-padding">
              <table class="table table-hover table-bordered table-striped" id="tableKaryawan">
               ...
               foreach ($dataGaji as $tampil):?>
                ...
                <!--  <td>
                    ...
                    <a class="btn btn-danger btn-sm" href="<?=site_url("")?>" onclick="return confirm('apakah anda yakin ?')" ><i class="fa fa-trash-o"></i></a>
                    </td -->
                </tr>
              <?php endforeach;?>
              </tbody>
              <tfoot>
                  <tr>
                    <td colspan="5" align="left"><b>Total Tunjangan</b></td>
                    <td colspan="3"><b><?php echo number_format($totalTunjangan,0,',','.') ?></b></td>
                  </tr>
                  <tr>
                    <td colspan="5" align="left"><b>Gapok & Tunjangan</b></td>
                    <td colspan="3"><b><?php echo number_format($GapokTunjangan,0,',','.') ?></b></td>
                  </tr>
